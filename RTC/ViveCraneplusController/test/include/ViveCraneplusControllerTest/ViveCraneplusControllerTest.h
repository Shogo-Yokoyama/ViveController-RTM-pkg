// -*- C++ -*-
/*!
 * @file  ViveCraneplusControllerTest.h
...
#ifndef VIVECRANEPLUSCONTROLLER_TEST__H
#define VIVECRANEPLUSCONTROLLER_TEST_H
...
/*!
 * @class ViveCraneplusControllerTest
 * @brief The controller of CRANE+ with HTC VIVE
 *
 */
class ViveCraneplusControllerTest
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ViveCraneplusControllerTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~ViveCraneplusControllerTest();
...
extern "C"
{
  DLL_EXPORT void ViveCraneplusControllerTestInit(RTC::Manager* manager);
};

#endif // VIVECRANEPLUSCONTROLLER_TEST_H
