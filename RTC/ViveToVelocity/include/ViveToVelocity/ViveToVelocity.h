...
#ifndef VIVETOVELOCITY_H
#define VIVETOVELOCITY_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ViveToVelocity(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void ViveToVelocityInit(RTC::Manager* manager);
};

#endif // VIVETOVELOCITY_H
